# DIAGNOSTIC COPY (theta>0.40 extension) of modular_www_v2.py — telemetry only, NOT the preregistered decision run.
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
THETA_SWEEP = [0.05, 0.10, 0.20, 0.40, 0.60, 0.80, 1.20, 1.60, 2.40]  # DIAGNOSTIC theta-hi extension (audit T-WWR): find where the D>theta trigger stops firing 100%
W_SWEEP     = [2, 4, 8]
...
def main():
    ...
    out_dir = os.path.join(here, "modular_www_v2_thetahi_outputs")
