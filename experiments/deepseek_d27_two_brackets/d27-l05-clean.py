...
CAND = Path('/Users/peterviviani/golden-horizon-principle/experiments/fable_d22_test2/d22_cand2_odd_L0.5.json')
...
(HERE / 'd27-l05-bracket.json').write_text(json.dumps(out, indent=1) + '\n')
