...
LSTR, TVAL, NE_, KN, PAR = '0.5', 160, 160, 64, 'odd'
...
src = src.replace('open(f"d5_results_{PAR}_NE{NE}_pole{POLE:+d}.json","w")',
                  'open(f"/Users/peterviviani/golden-horizon-principle/experiments/deepseek_d26_bracket/d26_cert_visible_L05_{PAR}_L{LSTR}_T{TVAL}_N{NE}.json","w")')
