...
CAND = Path('/Users/peterviviani/golden-horizon-principle/experiments/deepseek_d26_bracket/d26_cand_unconstrained_odd_L0.5.json')
...
L = arb(1) / 2  # D26: L=0.5 rescore (was 2/5 in the copied script)
modes = cand['modes']
...
(HERE / 'd26-bracket-L05-moveb.json').write_text(json.dumps(out, indent=1) + '\n')
