...
This attacks the stronger v41 stack:
...
OUT = ROOT / "golden_zipper_v41b_outputs"
V41_SUMMARY = ROOT / "golden_zipper_v41_outputs" / "summary.csv"

SEED = 20260526
RNG = np.random.default_rng(SEED)
MODES = ["real", "no_binding", "shuffled_phase", "flat_binding", "no_multiscale", "no_band"]
...
def main() -> None:
    ...
    report = f"""# Golden Zipper v41b - Field-Binding Stack Nulls
...
"""
    ...
    print(f"golden no-multiscale gap: {golden['no_multiscale_gap']:.3f}")
