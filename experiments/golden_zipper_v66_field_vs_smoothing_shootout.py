#!/usr/bin/env python3
"""v66 field vs smoothing shootout."""
...
OUT = ROOT / "golden_zipper_v66_outputs"

SOURCES = {
    "v41b_field_stack": ROOT / "golden_zipper_v41b_outputs" / "summary.csv",
    "v64_binding_specificity": ROOT / "golden_zipper_v64_outputs" / "summary.csv",
    "v65_field_vs_smoothing": ROOT / "golden_zipper_v65_outputs" / "summary.csv",
...
def pick_score(row: dict[str, str]) -> float:
    for key in ("real_score", "nested_moderate_score"):
        if key in row:
...
def main() -> None:
    ...
    best = ranked[0]
    report_lines = [
        "# Golden Zipper v66 - Field vs Smoothing Shootout",
        "",
