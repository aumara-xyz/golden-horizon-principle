...
This combines the strongest two recent ideas:
- relational field identity
- phase binding inside the field
- nested observer windows that can stabilize the field at multiple scales
...
OUT = ROOT / "golden_zipper_v40_outputs"
...
def build_field_sequence(
    ...
    split_events = context_distortions = blocked_contexts = overlap_events = phase_bind_events = macro_window_events = 0
...
def main() -> None:
    ...
    report = f"""# Golden Zipper v40 - Multiscale Phase Binding
