#!/usr/bin/env python3
"""v60b core-frame vs lens shootout."""
...
OUT = ROOT / "golden_zipper_v60b_outputs"
...
SOURCES = {
    ...
    "v60_frame_lens": ROOT / "golden_zipper_v60_outputs" / "summary.csv",
}
...
def main() -> None:
    ...
    best = ranked[0]
    report_lines = [
        "# Golden Zipper v60b - Core Frame vs Lens Shootout",
        "",
