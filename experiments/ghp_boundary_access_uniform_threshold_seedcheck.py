#!/usr/bin/env python3
"""Seed check around the uniform-smear crossover band.
...
OUT = ROOT / "ghp_boundary_access_uniform_threshold_seedcheck_outputs"
...
def main() -> None:
    ...
    write_csv(rows, OUT / "threshold_seed_metrics.csv")

    lines = [
        "# Boundary Access Uniform Threshold Seed Check",
        "",
        f"- seeds `{SEEDS}`",
        "",
