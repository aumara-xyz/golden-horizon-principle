#!/usr/bin/env python3
"""v42b prediction-error field nulls.

This attacks the v42 admission-band object:
- moderate band
- over-wide band
- wrong-center band
- no band
...
OUT = ROOT / "golden_zipper_v42b_outputs"
...
def main() -> None:
    ...
    report = f"""# Golden Zipper v42b - Prediction Error Field Nulls
