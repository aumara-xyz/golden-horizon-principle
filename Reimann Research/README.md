...
2. [Latest Fable audit: D6](../experiments/weil_hidden_modes/FABLE-ROUND-D6-RESULTS.md)
3. [Codex gear / prime-coordinate / ternary toy results](../experiments/prime_gears_codex/RESULTS.md)
4. [Next directive: Opus D7 independent audit](NEXT-ROUND-D7.md)

**Status:** Fable reports compact-window positivity at L=0.7, both parity sectors, subject to the documented analytic dependencies and outstanding independent reconstruction. Codex has not independently replayed the complete certificate. No RH proof, new all-window positivity argument, physical hologram result, or novelty claim has been established. GHP's c=0.7 central charge and the chosen L=0.7 cutoff are different quantities with no established bridge.
