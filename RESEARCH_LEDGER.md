...
| SILVER-OPT | Characterize the silver anomaly (silver ≥ golden on four independent instruments) | **PREREG SIGNED/LOCKED 2026-08-01 — build authorized** (SHA-256 `034dbb47b56dcd956732d2873afac11e4748e8f093b46d82c6b07552a3f139d2`) | named 2026-07-07 (v2.1 edition); restored 2026-07-29 | GH-RECOV critical band + adversarial tear (~5σ for silver); T-111 sampler friction; T-112 rotation ranking; SEL-CLOSE-001 KAM thresholds | Constant-axis anomaly (see M-006: no silver fusion category exists, so no structural reading). Three preregistered hypotheses, each with a kill: H1 silver-optimal (a GHP-independent result about low-discrepancy allocation) · H0 noble-plateau · H2 damage-geometry artifact. Not GHP physics under any branch |
...
| AH.4-P1 | **Genuine Fibonacci-anyon fusion-tree recoverability code** | **PREREG SIGNED/LOCKED 2026-08-01 — build authorized** | Prereg v1.1 signed by owner (chat directive); pass-region excludes the generic answer (flat-in-structure = falsifier); signed-file SHA-256 `44d60ed27855079e99eb7d95f3ab03e03fafddc29e3e5e605bccb97f8729518c`; the proxy (GH-RECOV) and allocation replication (K-RECOV-001) remain negative and recorded |
