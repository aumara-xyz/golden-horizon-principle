...
| SILVER-OPT-GEO | Silver anomaly at its original address (placement geometry) | **PREREG SIGNED/LOCKED 2026-08-01 — build authorized** | signed 2026-08-01 (SHA `9b429ba72092ef26…`) | substrate: `ghp_golden_heal_probe.py` family reused verbatim; seeds 4000–4099; branches G1 real / G0 dissolved / G2 reversed, each with a kill | Constant/placement axis (M-006); not GHP physics under any branch |
...
| AH4-P1-POWERED | Powered structural sequel: 400 fresh seeds, declared high-damage rule | **PREREG SIGNED/LOCKED 2026-08-01 — run authorized** | v2 contract SHA `bcea7ce761484162…`; pipeline pinned byte-identical SHA `59fc150a67971c1a…`; PASS = Δ(0.50) AND Δ(0.75) > +0.02 with CIs excluding 0; KILL = either fails → structural-advantage hypothesis dead at n=12 under this channel; v1 seeds excluded |
