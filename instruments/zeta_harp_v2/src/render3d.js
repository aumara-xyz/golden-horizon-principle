...
var GLR = (function () {
  ...
  if (ok) {
    helixProg = compile(
      ...
      'uniform mat4 uVP; uniform float uHalfW,uThpp,uThppp,uZScale,uRScale,uSel,uNlive;\n' +
      'out vec4 vColor;\n' +
      'void main(){\n' +
